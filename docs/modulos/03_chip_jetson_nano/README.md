...
<center>
  <em>Figura 1. Arquitectura de Tegar X1. Fuente: NVIDIA, 
  <a href="..\..\PDF\TegraX1_Embedded_DataSheet_DS07224007v1.0.pdf" target="_blank">
  Data Sheet — Tegra X1 Series Processors Maxwell GPU + ARM v8
  </a>.</em>
</center>
...
<center>
  <em>Figura 2. CPU vs GPU. Fuente: NVIDIA, 
  <a href="..\..\PDF\CUDA_C_Programming_Guide.pdf" target="_blank">
...
En el diseño del módulo Nano, es posible conectar **hasta dos cámaras** mediante interfaces **MIPI CSI-2**, configurables como **1×4** o **2×2 lanes**. El ISP soporta sensores de hasta **24 MP** y puede procesar imágenes a una tasa de hasta **1. GP/s (gigapíxeles cada segundo)**.
